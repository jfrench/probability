...
You enter a chess tournament where your probability of wining a game is 0.3 against halp the players (type 1), 0.4 against a quarter of the players (type 2), and 0.5 against the remaining quarter of the players (type 3).
...
We want to estimate the probability of three mutually exclusive and collectively exhaustic potential causes: 1. a malignant tumor ($A_1$), 2. a non-malignant tomor ($A_2$), 3. something other than a tumor ($A_3$).
