...
Are the events below independent?
$$
A = \{1\text{st roll is a }1\}, \quad
B = \{\text{sum of the two rolls is }5\}
$$
...
Are the events below independent?
$$
A = \{\text{maximum of the two rolls is }2\},
$$
$$
B = \{\text{minimum of the two rolls is }2\}
$$
...
There are two coins, a blue and red one. We choose one of the two coins at random, each being chosen with probability $1/2$. We proceed with two independent tosses. The coins are biased: with the blue coin, the probability of heads in any given toss is 0.99, whereas for the red coin it is 0.01. 

Let $B$ be the event that the blue coin was selected. Let $H_i$ be the event that the $i$th toss results in a head. 
