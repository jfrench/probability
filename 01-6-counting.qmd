...
![Illustration of the basic counting principle](./images/f1-17.png){height=70% fig-alt="Illustration of the basic counting principle."}
...
A local telephone number is a 7-digit sequence, but the first digit must be different from 0 or 1. How many distinct telepone numbers are there?
...
You have $n_1$ classical music albums, $n_2$ rock music albums, and $n_3$ country music albums.

How many different ways can you arrange the albums so that the albums of the same type are contiguous?

# Combinations

## Combination context

There are $n$ people and we are interested in forming a committee of size $k$. How many different committees are possible?
